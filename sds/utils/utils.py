...
def load_objs(sds_root_path: Path, target_dataset_name: str, distractor_dataset_name: Optional[str] = None,
              models_subdir: str = 'models', load_meshes: bool = False, load_target_id_num: Optional[int] = None) -> Dict[str, Dict]:
    ...
    for obj_id, obj in target_objs.items():
        ...
        if load_meshes and (load_target_id_num is None or load_target_id_num == obj['id_num']):
